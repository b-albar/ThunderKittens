...
#if KITTENS_ARCH >= 900 && KITTENS_ARCH < 1000
#define TEST_ALL_GROUP_MMA_WARPGROUP
#endif
#ifdef KITTENS_ARCH >= 1000
...
#if KITTENS_ARCH == 900 // only compile on H100
...
#define TEST_GROUP_MEMORY_VEC_PGL_TO_REGISTER
...
#define TEST_GROUP_MMA_WARPGROUP
    ...
    defined(TEST_GROUP_MEMORY_TILE_PGL_TO_REGISTER) || defined(TEST_GROUP_MEMORY_TILE_SHARED_TO_REGISTER)
#define TEST_GROUP_MEMORY_TILE
    ...
    defined(TEST_GROUP_MEMORY_VEC_PGL_TO_REGISTER) || defined(TEST_GROUP_MEMORY_VEC_SHARED_TO_REGISTER)
